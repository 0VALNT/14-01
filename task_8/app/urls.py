...
from .views import DeviceCreate, DeviceList, DeviceDetail, NumberCreate, NumberList, NumberDetail, number_delete, \
    device_delete
...
from .views import DeviceUpdate, NumberUpdate

urlpatterns += [
    path('device/update/<int:pk>', DeviceUpdate.as_view(), name='device_update'),
    path('number/update/<int:pk>', NumberUpdate.as_view(), name='number_update'),
]
